...
//                       @"D:\Dropbox\metaverse\ConsoleApp1\ConsoleApp1\Python\gesticulator\gesticulator\visualization"
                    @"C:\Users\CY\Desktop\pythonRuntime\Assets\pythonCode",
                   @"C:\Users\CY\Desktop\pythonRuntime\Assets\pythonCode\gesticulator",
                     @"C:\Users\CY\Desktop\pythonRuntime\Assets\pythonCode\gesticulator\gesticulator",
                     @"C:\Users\CY\Desktop\pythonRuntime\Assets\pythonCode\gesticulator\gesticulator\visualization"
...
print(sys.version); ");
                ...
                os.chdir(@"c:\users\cy\desktop\pythonruntime\assets\pythoncode\gesticulator\demo");
                pycwd = os.getcwd();
                cwd = (string)pycwd;
                ...
                dynamic  pyresult =  mod.add(1,2); //add 함수 호출
                int result = (int) pyresult;
               ...
               // dynamic arg_model_file  = demo.main();
                ...
                float[,,] motionFromPythonArray = (float[,,])motionFromPython;

                int firstDimLength = motionFromPythonArray.GetLength(0);
                int secondDimLength = motionFromPythonArray.GetLength(1);
                int thirdDimLength = motionFromPythonArray.GetLength(2);
                ...
                //{
                    ...
                    Console.Write("row: {0}", j);
                        for (int k = 0; k < thirdDimLength; k++)
                        {
                        //    Console.Write("{0}\t", sysPath[i]);

                        Console.Write("{0}\t", motionFromPythonArray[0,j,k]);
                ...
                //Console.WriteLine("\n args.model_file:{0}", arg_model_file);
